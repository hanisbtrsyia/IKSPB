...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
       ...
       <!-- Custom styles for this template -->
        ...
        <!--<script src="../assets/_e-commerce.scss" type="text/javascript"></script>-->
...
<div class="content-wrapper" style="min-height: 2646.44px;">
    ...
    <h3 class="d-inline-block d-sm-none">Kerepek Peria Wanz Bitez</h3>
    <div class="col-12">
    <img src="../../assets/images/produk/peria.jpg" class="product-image" alt="Product Image" style="width:100%">
    </div>
    ...
    <div class="col-12 col-sm-6">
    <h3 class="my-3">Kerepek Peria Wanz Bitez</h3>
    <p>Kerepek Bawang - The Raya Mood Lifter

      Pada musim raya rumah nenek-nenek gemar menghidangkan ini kepada tetamunya. Ia seperti senjata rahsia nenek untuk membuat cucu-cucunya tinggal lebih lama. Ahh saat-saat menenangkan itu.
      
      Kerepek bawang yang baik mesti nipis dengan rangup. Cubalah, pasti membawa mood raya ke rumah anda.</p>
    <hr>
    ...
    <h4 class="mt-0">
    <small>Kategori: Kerepek</small>
    </h4>
    <h4 class="mt-0">
      <small>Berat: 300gm</small>
    </h4>
    <h4 class="mt-0">
      <small>Unit: 1</small>
    </h4>
    ...
    <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"> Kerepek Bawang - The Raya Mood Lifter

      Pada musim raya rumah nenek-nenek gemar menghidangkan ini kepada tetamunya. Ia seperti senjata rahsia nenek untuk membuat cucu-cucunya tinggal lebih lama. Ahh saat-saat menenangkan itu.
      
      Kerepek bawang yang baik mesti nipis dengan rangup. Cubalah, pasti membawa mood raya ke rumah anda. </div>
