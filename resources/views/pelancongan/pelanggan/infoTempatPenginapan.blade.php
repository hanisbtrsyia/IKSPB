                                    ...
                                    <div class="card text" style="max-width: 15rem; background-color:#eeeeee;">
                                        <div class="card-body">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                viewBox="0 0 473.578 473.578"
                                                style="enable-background:new 0 0 473.578 473.578;" xml:space="preserve">
                                                <g>
                                                    <g>
                                                        <path
                                ...
                                <div class="col-3">
                                    <div class="card text" style="max-width: 15rem; background-color:#eeeeee;">
                                        <div class="card-body">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-speaker" viewBox="0 0 16 16">
                                        ...
                                        <div class="card-body" style="min-height: 164px;">
                                            ...
                                            <p class="card-text">Menyediakan mesin basuh untuk memudahkan pelanggan.</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="card text" style="max-width: 15rem; background-color:#eeeeee;">
                                        <div class="card-body">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-snow" viewBox="0 0 16 16">
                                        ...
                                        <div class="card-body" style="min-height: 164px;">
                                            ...
                                            <p class="card-text">Mesin pengering ada disediakan bagi kegunaan pelanggan.</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
