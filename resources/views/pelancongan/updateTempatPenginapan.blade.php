                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inputSkills" name="NoTel"
                                            value="{{ $temPenginapan->NoTel }}" placeholder="+601-####-####">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="HargaPerMalam" id="HargaPerMalam" class="form-control"
                                            value="{{ $temPenginapan->HargaPerMalam }}" placeholder="">
                                    </div>
                                    <div class="form-group">
