  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="main_nav">
        ...
        <div class="col-12">
            ...
            <li class="nav-item">
            <a class="nav-link" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="false">Tempat Perkhemahan</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Tempat Bersejarah</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#custom-tabs-four-messages" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">Hijau-Hijauan</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" id="custom-tabs-four-settings-tab" data-toggle="pill" href="#custom-tabs-four-settings" role="tab" aria-controls="custom-tabs-four-settings" aria-selected="true">Pantai</a>
            </li>
            </ul>
            </div>
           <!-- <div class="card-body">
...
<div class="row">
  ...
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      <a href="{{ route('TempatMenarik.edit', $temMen->id_tempatMenarik) }}" class="img-wrap"> <img src="{{ asset('assets/images/attractions/'.$temMen->gambar)}}" style="width:261px; height:200px;"> </a>
  ...
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      <a href="#" class="img-wrap"> <img src="assets/images/attractions/tamannegara.jpg"> </a>
      <figcaption class="info-wrap">
        <a href="#" class="title">Taman Negara</a>
  ...
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      <a href="#" class="img-wrap"> <img src="assets/images/attractions/airterjun.jfif"> </a>
      <figcaption class="info-wrap">
        <a href="#" class="title">Air Terjun Chamang</a>
  ...
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      <a href="#" class="img-wrap"> <img src="assets/images/attractions/rompin.jpg"> </a>
      <figcaption class="info-wrap">
        <a href="#" class="title">Taman Negeri Rompin</a>
