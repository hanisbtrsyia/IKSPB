        ...
        <div class="col-md-10 col-lg-8 col-xl-6">
            ...
            <div class="basket-product">
                <div class="item">
                  <div class="product-image">
                    <img src="../assets/images/produk/peria.jpg" alt="Placholder Image 2" class="product-frame">
                  </div>
                  <div class="product-details">
                    <h1><strong><span class="item-quantity">4</span> x Eliza J</strong> Kerepek Peria Wanz Bitez</h1>
              ...
              <div class="basket-product">
                <div class="item">
                  <div class="product-image">
                    <img src="../assets/images/produk/ubi.jfif" alt="Placholder Image 2" class="product-frame">
                  </div>
                  <div class="product-details">
                    <h1><strong><span class="item-quantity">1</span> x Whistles</strong> Kerepek Ubi Kari Adrianna Anissa</h1>
         ...
         <br>
                ...
                <div class="form-group">
                    <input type="text" name="Emel" id="Emel" class="form-control" placeholder="E-mel">
                </div></div>
                <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="No Telefon" id="No Telefon" class="form-control" placeholder="No Telefon">
                </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="Poskod/Zip" id="Poskod/Zip" class="form-control" placeholder="Poskod/Zip">
                </div></div>
                <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="Bandar" id="Bandar" class="form-control" placeholder="Bandar">
                </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="summary-checkout">
                    <a href="/belibelah/membuatpesanan"><button class="checkout-cta">Semak Keluar</button></a>
                </div>
                <br>
          </div>
          </div>
