...
<nav class="navbar navbar-main navbar-expand-lg navbar-light border-bottom">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="main_nav">
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link pl-0" data-toggle="dropdown" href="#"><strong> <i class="fa fa-bars"></i>    Kategori</strong></a>
...
<header class="section-heading">
  <h3 class="section-title">Tempat Menarik</h3>
</header><!-- sect-heading -->
...
<div class="container">
<header class="section-heading">
  <h3 class="section-title">Tempat Penginapan</h3>
</header><!-- sect-heading -->
<div class="row">
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      <a href="#" class="img-wrap"> <img src="assets/images/penginapan/neyo1.webp"> </a>
      <figcaption class="info-wrap">
        <a href="#" class="title">Neyo Homestay@Cameron Highlands (Bandar Brinchang)</a>
