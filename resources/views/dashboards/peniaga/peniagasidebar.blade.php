    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #000">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">{{ \Illuminate\Support\Facades\Auth::user()->name }} | {{ ucfirst(\Illuminate\Support\Facades\Auth::user()->role) }}</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open">
              <li class="nav-item">
              <a href="/pelancongan/peniaga/homeTempatPenginapan" class="nav-link active" style="background-color: #ffb923">
              ...
              <li class="nav-item">
              <a href="/pelancongan/updateTempatPenginapan" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item menu-is-opening menu-open">
                <li class="nav-item">
                <a href="/pelancongan/peniaga/homebelibelah" class="nav-link active" style="background-color: #ffb923">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>
                Produk
                <i class="right fas fa-angle-left"></i>
